        ...
        Highcharts.chart('empContainer', {
            ...
            drilldown: {
                series: [{
                    ...
                    id: 'micro',
                    data: [
                        ['Active', Math.round((data.micro.Active / data.micro.total * 100)*100)/100],
                        ['Dissolved', Math.round((data.micro.Dissolved / data.micro.total * 100)*100)/100]
                    ]
                }, {
                    name: 'Small enterprise',
                    id: 'mini',
                    data: [
                        ['Activee', Math.round((data.mini.Active / data.mini.total * 100)*100)/100],
                        ['Dissolved', Math.round((data.mini.Dissolved / data.mini.total * 100)*100)/100]
                    ]
                }, {
                    name: 'Medium Enterprise',
                    id: 'middle',
                    data: [
                        ['Activee', Math.round((data.middle.Active / data.middle.total * 100)*100)/100],
                        ['Dissolved', Math.round((data.middle.Dissolved / data.middle.total * 100)*100)/100]
                    ]
                }, {
                    name: 'Large Enterprise',
                    id: 'big',
                    data: [
                        ['Activee', Math.round((data.big.Active / data.big.total * 100)*100)/100],
                        ['Dissolved', Math.round((data.big.Dissolved / data.big.total * 100)*100)/100]
                    ]
                }]
            }
        });
